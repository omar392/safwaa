        ...
        <div class="container">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <input type="number" name="solved" class="form-control" id="input0" placeholder="القضايا التى حلت">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">القضايا  قيد الانتظار</label>
                    <input type="number"  name="waited" class="form-control" id="input0" placeholder="القضايا  قيد الانتظار">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">القضايا محل الدراسة</label>
                    <input type="number"  name="studied" class="form-control" id="input0" placeholder="القضايا محل الدراسة">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">قضايا خسرت</label>
                    <input type="number" name="losed" class="form-control" id="input0" placeholder="قضايا خسرت ">
                </div>
            </div>
            <div class="form-group">
