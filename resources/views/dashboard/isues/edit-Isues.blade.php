        ...
        <div class="container">
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <input type="number" name="solved" class="form-control" id="input0" value="{{$edit_data->solved}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">القضايا قيد الانتظار </label>
                    <input type="number"  name="waited" class="form-control" id="input0"value="{{$edit_data->waited}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">قضايا تدرس</label>
                    <input type="number"  name="studied" class="form-control" id="input0" value="{{$edit_data->studied}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">Lower Degree</label>
                    <input type="number" name="losed" class="form-control" id="input0" value="{{$edit_data->losed}}">
                </div>
            </div>
            <div class="form-group">
