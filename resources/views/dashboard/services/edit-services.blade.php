        ...
        <div class="container">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <textarea name="description_ar" class="form-control" id="" cols="160" rows="10">{{$edit_data->description_ar}}</textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
                    <label for="input0" class="col-sm-2 control-label bring_right left_text">Services Description</label>
                    <textarea name="description_en" class="form-control" id="" cols="160" rows="10">{{$edit_data->description_en}}</textarea>
