<div class="row header_section">
    <div class="col-sm-3 col-xs-12 logo_area bring_right">
        <h1 class="inline-block"><img src="img/logo.png" alt="">لوحة تحكم الصفوة</h1>
    ...
    <div class=" col-sm-4 col-xs-12 user_header_area bring_left left_text">
        ...
        <div class="user_info inline-block">
            <img src="{{asset('dashboard/img/logo0.png')}}" alt="" class="img-circle">
            <span class="h4 nomargin user_name">الصفوة Al-Safwaa</span>
